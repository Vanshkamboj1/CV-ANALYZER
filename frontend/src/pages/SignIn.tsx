...
const SignIn = () => {
  ...
  return (
    <AuthLayout title="Sign In" subtitle="Access your HR dashboard">
      ...
      {/* 🔥 Bottom-right Render Info Box */}
      <div className="fixed bottom-4 right-4 backdrop-blur-md bg-white/80 border border-gray-200 text-gray-800 px-4 py-3 rounded-2xl shadow-lg max-w-xs text-sm">
        <p className="font-semibold">🚀 Deployment Info</p>
        <p className="mt-1 text-gray-600">
          Backend is hosted on Render. First request may take 2-3 minutes due
          to cold start.
        </p>
      </div>
    </AuthLayout>
